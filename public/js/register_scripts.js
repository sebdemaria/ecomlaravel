  ...
  formulario.onsubmit = function(event) {
    for(var elemento of formulario.elements) {
      ...
      if (elemento.name == 'nombre') {
        if (elemento.value.trim() == '' || elemento.value.trim() != regexNombre) {
      ...
      if (elemento.name == 'email') {
        if (elemento.value.trim() == '' || elemento.value.trim() != regexEmail) {
          event.preventDefault();
      ...
      if (elemento.name == 'password') {
        if (elemento.value.trim() == '' || elemento.value.trim() != regexPass) {
          event.preventDefault();
